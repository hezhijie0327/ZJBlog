/**
 * 设计语言类片段单一来源（沿用 ZJSearch 的 lib/styles.ts 约定）
 *
...
export const LIST_CONTAINER =
  "divide-y divide-line/70 rounded-2xl border border-line bg-surface"
...
/** 标签胶囊 */
export const CHIP =
  "inline-flex items-center rounded-full border border-line px-2.5 py-0.5 text-xs text-ink-2"
